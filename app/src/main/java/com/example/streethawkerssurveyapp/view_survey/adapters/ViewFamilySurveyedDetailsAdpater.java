...
public class ViewFamilySurveyedDetailsAdpater extends RecyclerView.Adapter<ViewFamilySurveyedDetailsAdpater.MyPassengerHolder> {

    private Context context;
    private List<FamilyMembersBeenSurveyedItem> familyMembersList;

    public ViewFamilySurveyedDetailsAdpater(Context context) {
    ...
    public void setDetails(List<FamilyMembersBeenSurveyedItem> familyMembersList) {
